...
const navigation = [
  ...
  { name: 'Services', href: '#', icon: WrenchScrewdriverIcon, current: false },
]
const teams = [
  { name: 'Help', href: '#', icon: QuestionMarkCircleIcon, current: false },
  { name: 'FAQ', href: '#', icon: ChatBubbleLeftRightIcon, current: false },
]
...
export default function Layout001SimpleSidebar() {
